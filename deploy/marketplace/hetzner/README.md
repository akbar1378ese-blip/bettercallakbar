# bettercallakbar on Hetzner Cloud

Hetzner Cloud does **not** have a third-party image marketplace the way AWS does.
Ship bettercallakbar via **cloud-init**: each instance installs non-interactively and
...
bettercallakbar non-interactively and generates unique per-instance credentials.
...
is essentially a documented cloud-init config plus metadata. To propose bettercallakbar as
