// Pure builders for bettercallakbar's subscription server: the subscription URLs plus
...
export function buildJsonSubscription(clients: SubClient[]): string {
  ...
  // bettercallakbar returns a single object for one client, an array for several.
