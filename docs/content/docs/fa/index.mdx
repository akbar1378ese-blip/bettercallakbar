---
title: مستندات bettercallakbar
description: مستندات رسمی bettercallakbar — یک پنل وب پیشرفته برای مدیریت سرورهای Xray-core، پروکسی‌ها، کلاینت‌ها و سابسکریپشن‌ها.
icon: House
---

**bettercallakbar** یک پنل وب متن‌باز برای استقرار و مدیریت سرورهای
...
<Callout type="info">
  با Xray تازه آشنا شده‌اید؟ ابتدا [bettercallakbar چیست؟](/docs/guide) را بخوانید — توضیح می‌دهد که پنل، Xray-core و
