...
**bettercallakbar** is a web control panel that sits on top of
...
<Mermaid
  chart={`
flowchart LR
  Admin["Admin browser"] -->|HTTPS panel| Panel["bettercallakbar panel"]
...
bettercallakbar is aimed at anyone running their own Xray server: from a single personal
...
<Callout type="info">
  ...
  accounting, multi-node management, and many quality-of-life features.
</Callout>
