---
title: Installation
description: Install bettercallakbar via the official script (stable, pinned, or dev-latest), unattended/cloud-init, or Docker — and choose SQLite or PostgreSQL.
icon: Download
---

bettercallakbar runs on a wide range of Linux distributions — Ubuntu, Debian, Armbian,
...
[releases page](https://github.com/akbar1378ese-blip/bettercallakbar/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/akbar1378ese-blip/bettercallakbar/tree/main/deploy)
