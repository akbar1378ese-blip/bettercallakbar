...
description: Manage bettercallakbar with the x-ui menu and CLI — update stable or dev builds, change settings, and uninstall cleanly.
icon: RefreshCw
---
...
| 5     | Legacy Version (Disabled)              | Upstream legacy installation is disabled in bettercallakbar     |
| 6     | Uninstall                              | Remove bettercallakbar (see below)                                  |
...
- **Legacy upstream versions:** disabled in bettercallakbar; use the stable or dev channel instead.
