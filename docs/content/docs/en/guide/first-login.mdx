---
title: First Login
description: Find your generated bettercallakbar credentials, reach the panel, enable two-factor auth, and harden it before exposing anything.
icon: KeyRound
---
...
bettercallakbar supports TOTP two-factor auth (compatible with Google Authenticator, Aegis,
