...
description: Fix common bettercallakbar problems — the panel won't start, 502 errors, certificate issues, and clients that can't connect.
icon: Wrench
---
...
<Callout type="info">
  ...
  [GitHub issues](https://github.com/akbar1378ese-blip/bettercallakbar/issues) — your symptom has
