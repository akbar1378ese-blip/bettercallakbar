---
title: Telegram Bot
description: Connect a Telegram bot to bettercallakbar for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

bettercallakbar can drive a Telegram bot for monitoring, alerts, backups, and remote
...
<Callout type="info">
  ...
  [@bettercallakbar](https://t.me/bettercallakbar). That's separate from the bot below, which you
