---
title: Subscription
description: Run the bettercallakbar subscription server — base64/JSON/Clash formats, ports and paths, TLS, response headers, and custom templates.
icon: Rss
---
...
routing, policy) plus a `proxy` outbound pointing at the inbound. bettercallakbar emits a
