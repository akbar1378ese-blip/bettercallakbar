---
title: bettercallakbar Documentation
description: Official documentation for bettercallakbar — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**bettercallakbar** is an open-source web panel for deploying and managing
...
<Callout type="info">
  New to Xray? Read [What is bettercallakbar?](/docs/guide) first — it explains how the panel, Xray-core, and
