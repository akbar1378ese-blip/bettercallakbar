---
title: 安全加固
description: 加固 bettercallakbar——面板认证与 2FA、自定义核心 IP 限制、防火墙规则、BBR，以及保持更新。
icon: ShieldCheck
---
...
正数表示接受最先出现的 N 个不同活动源 IP。bettercallakbar 固定使用的自定义 Xray 核心会在
...
定期更新 bettercallakbar 和 Xray-core——安全修复会随新版本发布。请关注
[发布页面](https://github.com/akbar1378ese-blip/bettercallakbar/releases)，并参见
