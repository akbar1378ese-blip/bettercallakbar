---
title: 安装
description: 通过官方脚本（稳定版、指定版本或开发最新版）、无人值守 / cloud-init 或 Docker 安装 bettercallakbar，并选择 SQLite 或 PostgreSQL。
icon: Download
---

bettercallakbar 可运行在多种 Linux 发行版上——Ubuntu、Debian、Armbian、
...
高级用户可从[发布页面](https://github.com/akbar1378ese-blip/bettercallakbar/releases)
下载适用于你架构的发布归档包，解压后
...
仓库的 [`deploy/`](https://github.com/akbar1378ese-blip/bettercallakbar/tree/main/deploy)
