---
title: 分享链接
description: bettercallakbar 的分享链接格式（vless、vmess、trojan、ss、hysteria2、mtproto）、备注模板变量，以及一个浏览器内的链接检查器。
icon: Link
---

bettercallakbar 会为每个客户端生成一个**分享链接**（以及二维码）。v2rayNG、Hiddify、Mihomo
