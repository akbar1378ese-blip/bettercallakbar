---
title: Установка
description: Установите bettercallakbar с помощью официального скрипта (стабильная, фиксированная или dev-сборка), в автоматическом режиме / через cloud-init либо в Docker — и выберите SQLite или PostgreSQL.
icon: Download
---

bettercallakbar работает на широком спектре дистрибутивов Linux — Ubuntu, Debian, Armbian,
...
bash <(curl -Ls https://raw.githubusercontent.com/akbar1378ese-blip/bettercallakbar/main/install.sh) v3.4.0
```
...
[страницы релизов](https://github.com/akbar1378ese-blip/bettercallakbar/releases), распаковать его и
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/akbar1378ese-blip/bettercallakbar/main/install.sh)
```

В каталоге [`deploy/`](https://github.com/akbar1378ese-blip/bettercallakbar/tree/main/deploy)
